...
import { animateSectionFadeIn } from "../utils/animation"
...
export default function About() {
  ...
  useGSAP(() => {
    if (objectiveRef.current) animateSectionFadeIn(objectiveRef.current, "left")
  }, [])

  useGSAP(() => {
    if (educationRef.current) animateSectionFadeIn(educationRef.current, "right")
  }, [])

  useGSAP(() => {
    if (skillsRef.current) animateSectionFadeIn(skillsRef.current, "up")
  }, [])

  useGSAP(() => {
    if (personalInfoRef.current) animateSectionFadeIn(personalInfoRef.current, "left")
  }, [])

  useGSAP(() => {
    if (referenceRef.current) animateSectionFadeIn(referenceRef.current, "up")
  }, [])
    ...
    <AnimatedPage>
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Career Objective */}
          <section ref={objectiveRef} className="mb-16">
          ...
          {/* Reference */}
          <section ref={referenceRef} className="mt-16">
